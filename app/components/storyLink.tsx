...
const StoryLink = (props: Props) => (
  <Link href={`/post/${props.post_id}`} className="flex hover:bg-cyan-100/10 mt-1 lg:mt-10 duration-150 lg:rounded-l-full border-2 border-[#859900] w-screen lg:w-3/4 h-32 z-10">
